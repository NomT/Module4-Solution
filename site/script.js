...
//console.log(" " + names);
 ...
 //  console.log("123 " + names[i]);
 //}

 var names = ["Yaakov", "John", "Jen", "Jason", "Paul", "Frank", "Larry", "Paula", "Laura", "Jim"];
  
// hutconsole.log(charAt(3));
...
//names[i] = names[i].charAt(0).toLowerCase() + names[i].substr(1,names[i].length-1);
...
for (var i = 0; i < names.length; i++) {
   ...
   { 
      if (firstLetter === 'j') {
        console.log("GoodBye Loop: " + names[i]);
        byeSpeaker.speakWord(names[i]); 
        //console.log(+byeSpeaker.speakWord(names[i])); 
        console.log("NOW Name: " +byeSpeaker.speakWord(names[i]));
        //byeSpeaker.speakWord();
        //console.log(byeSpeaker.speakWord() +names[i]);
         } else  {
        console.log("Hello Loop: " +names[i]);
